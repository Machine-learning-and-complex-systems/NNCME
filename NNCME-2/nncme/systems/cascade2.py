"""Non-linear cascade reaction network with Hill-type regulation."""

import numpy as np
import torch

class cascade2:
    """Cascade network with sigmoidal activation for intermediate species."""
    ...
    def Propensity(self,Win,Wout,cc,SampleNeighbor1D_Win,SampleNeighbor1D,NotHappen_in_low,NotHappen_in_up,NotHappen_out_low,NotHappen_out_up):
        # Optional alternative forms for experimentation:
        # Win[:,:,1:Win.shape[2]:2] = 1 + ...
        """Propensity operation.
        """
        ...
        Win[NotHappen_in_low]=0
        Win[NotHappen_in_up]=0
        Wout[NotHappen_out_low]=0
        Wout[NotHappen_out_up]=0
