"""Inverse cascade reaction network with final species as the input."""
...
class cascade1_inverse:
    """Cascade where the downstream species controls upstream activation."""
    ...
    def rates(
        ...
        reaction_left[-1, 0] = 1.0
        if self.L >= 2:
            reaction_left[-2, 2 * (self.L - 1)] = 0.0
