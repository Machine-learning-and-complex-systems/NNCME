...
class Epidemic:
    ...
    def rates(self,Tstep,delta_t):  
        ...
        initialD=np.array([50,10,-1]).reshape(1,self.L)#0.1#0.1 # the parameter for the initial Poisson distribution
        # self.IniDistri='poisson'
        # initialD=np.array([50,5,0]).reshape(1,self.L)#0.1#0.1 # the parameter for the initial Poisson distribution
        # IniDistri='poisson'
        # print(self.IniDistri)
        # Reaction matrix
