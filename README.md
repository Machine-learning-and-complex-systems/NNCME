...
To try running the existing program, please refer to `Code\RunGeneExpression.ipynb`. To learn how to extend and implement new examples, please refer to `A Simple Template.ipynb` and `Detailed Version of Gene Expression.ipynb`. 
...
Contact: Ying Tang, jamestang23@gmail.com; Jiayu Weng, yukiweng0602@gmail.com
